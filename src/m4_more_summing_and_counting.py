...
def run_test_factorial():
    ...
    # -------------------------------------------------------------------------
    # Test 3:
    answer_from_oracle = math.factorial(23)
    answer_from_my_code = factorial(23)
...
def run_test_count_cosines_from():
    ...
    # Test 4:
    expected = 0
    answer = count_cosines_from(3, 3, 0.29)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)
    # Test 5:
    expected = 6
    answer = count_cosines_from(4, 9, -1.00)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)
    # Test 6:
    expected = 2
    answer = count_cosines_from(6, 8, 0.29)
